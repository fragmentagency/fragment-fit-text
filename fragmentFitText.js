...
var FitTextElement = function () {
    function FitTextElement(element, type, minSize, maxSize, textLineHeight) {
    ...
    FitTextElement.prototype.testElementRatios = function testElementRatios() {
        if (['oneline-height'].indexOf(this.type) !== -1) {
            ...
            var _computedStyle = getComputedStyle(this.testTag);
            var _elementHeight = this.testTag.clientHeight; //height with padding
            _elementHeight -= parseFloat(_computedStyle.paddingTop) + parseFloat(_computedStyle.paddingBottom);
            return {
                height: _elementHeight / this.lineHeight,
                width: this.testTag.scrollWidth / this.size.width
            };
        } else {
            return {
    ...
    FitTextElement.prototype.calculateLineHeight = function calculateLineHeight(currentFontSize) {
...
var FitText = function () {
    ...
    FitText.prototype.add = function add(selector) {
        ...
        var textLineHeight = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 1;
    ...
    FitText.prototype.run = function run(fontsToWaitFor, callback) {
        var _this2 = this;
